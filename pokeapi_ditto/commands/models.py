...
COMMON_MODELS: dict[str, Any] = {
    ...
    "/schema/v2/api_resource_list.json": {
        "properties": {
            ...
            "previous": {"type": "null"},
            "results": {
                "items": {"$ref": "/schema/v2/api_resource.json"},
                "type": "array",
            },
        },
    ...
    "/schema/v2/named_api_resource_list.json": {
        "properties": {
            ...
            "previous": {"type": "null"},
            "results": {
                "items": {"$ref": "/schema/v2/named_api_resource.json"},
                "type": "array",
            },
        },
        "required": ["count", "next", "previous", "results"],
    ...
    "/schema/v2/encounter.json": {
        "properties": {
            ...
            "method": {"$ref": "/schema/v2/named_api_resource.json"},
    ...
    "/schema/v2/generation_game_index.json": {
        "properties": {
            ...
            "generation": {"$ref": "/schema/v2/named_api_resource.json"},
        },
    ...
    "/schema/v2/machine_version_detail.json": {
        "properties": {
            "machine": {"$ref": "/schema/v2/api_resource.json"},
